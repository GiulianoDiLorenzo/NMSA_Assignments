...
N_pts_list = [10+1, 50+1, 100+1, 150 + 1 , 200 + 1]; % Define the list of N_pts values
...
print('Q3a_omega_influence_dB', '-dpng',  '-r300');
...
print('Q3b_omega_influence_dB', '-dpng',  '-r300');
